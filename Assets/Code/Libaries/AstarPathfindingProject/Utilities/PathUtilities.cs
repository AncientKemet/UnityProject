...
namespace Pathfinding
{
	...
	public static class PathUtilities {
		 ...
		 * This is great if you want to pick a number of target points for group movement. If you pass all current agent points from e.g the group's average DirecionVector
